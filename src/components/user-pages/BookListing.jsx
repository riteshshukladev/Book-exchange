              ...
              <CardContent className="p-4 flex gap-4">
                ...
                <div className="flex flex-col justify-end">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-800 mb-1 font-kreon text-base tracking-wide">Author: {book.author}</p>
                    <p className="text-gray-800 mb-1 font-kreon text-base tracking-wide">Genre: {book.genre}</p>
                  </div>
